              ...
              {contactInfo.map(({ icon: Icon, label, value, href }) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-200 text-sm group-hover:text-primary transition-colors">
                      {value}
                    </p>
                  </div>
                </a>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <input
                  ...
                  required
                  className="w-full px-5 py-3.5 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-rose-500/50 focus:ring-1 focus:ring-rose-500/30 transition-all duration-300 text-sm"
                />
              </div>
              <div>
                <input
              ...
              <div>
                <textarea
                  ...
                  onChange={handleChange}
                  required
                  className="w-full px-5 py-3.5 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-rose-500/50 focus:ring-1 focus:ring-rose-500/30 transition-all duration-300 text-sm resize-none"
                />
              </div>
              <button
                type="submit"
